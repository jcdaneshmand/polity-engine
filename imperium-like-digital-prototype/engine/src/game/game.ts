...
import { acquireCard, endTurnMove, exhaustCard, innovateTurn, playCard, resolveChoice, resolveCleanupMarketResource, resolveDevelopmentChoice, resolveFindChoice, revoltTurn } from "./moves";
...
export const PrototypeGame: Game<GameState> = {
  ...
  moves: { playCard, acquireCard, exhaustCard, innovateTurn, revoltTurn, resolveChoice, resolveFindChoice, resolveDevelopmentChoice, resolveCleanupMarketResource, endTurn: endTurnMove }
};
