...
describe("private card import", () => {
  ...
  it("current engine effect ops validate, including nested choices and Exile/Unrest effects",()=> {
    const effect_ops_json=JSON.stringify([
      ...
      {trigger:"on_play",op:"move_resource_to_market",resource:"materials",amount:2},
      ...
      {trigger:"on_play",op:"discard_cards",count:1,suit:"region",cardType:"action"},
      ...
      {trigger:"on_play",op:"look_take_card",source:"deck",count:2,destination:"history"},
