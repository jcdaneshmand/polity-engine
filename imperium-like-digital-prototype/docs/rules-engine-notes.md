...
- Return a card moves the specified eligible Unrest card from the indicated player zone, usually hand or discard, back to the shared Unrest pile. During normal Scoring, card-specific effects such as Miyabi/Sumerians may return or choose Unrest from any scored zone when no narrower source is printed: hand, play area, discard pile, draw deck, History, or a nation-specific History replacement. Returning Unrest ignores the printed text on that Unrest card and does not use payment substitution.
