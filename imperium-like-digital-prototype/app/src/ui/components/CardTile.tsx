...
export function CardTile({ card, selected, disabled, compact, orientation = "portrait", affordability, onSelect }: { card: any; selected?: boolean; disabled?: boolean; compact?: boolean; orientation?: "portrait"|"landscape"; affordability?: string; onSelect?: () => void }) {
