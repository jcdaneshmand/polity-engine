...
export function createInitialGameState(args?: { options?: GameOptions; playerNationIds?: Record<string,string>; usePrivateData?: boolean; privateRulesetPath?: string; privateStrategyPath?: string }): GameState {
  ...
  const normCards = Object.fromEntries(Object.values(cards).map((c)=>[c.id,{id:c.id,displayName:c.displayName,suit:"none",cardType:"action",cost:{materials:c.cost ?? 0,population:0,progress:0,goods:0},developmentCost:{materials:0,population:0,progress:0,goods:0},vp:{mode:"none",value:null},startingLocation:"box",isTradeRouteExpansion:false,effects:c.effects as any,tags:c.tags,implemented:false,tested:false,requiredExpansions:[],allowedModes:["multiplayer","solo","practice"]}]));
